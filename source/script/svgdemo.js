...
var envinfo = {"qx.application":"svgdemo.Application","qx.revision":"","qx.theme":"svgdemo.theme.Theme","qx.version":"5.1"};
for (var k in envinfo) qx.$$environment[k] = envinfo[k];

if (!qx.$$libraries) qx.$$libraries = {};
var libinfo = {"__out__":{"sourceUri":"script"},"qx":{"resourceUri":"../../qooxdoo-master/framework/source/resource","sourceUri":"../../qooxdoo-master/framework/source/class","sourceViewUri":"https://github.com/qooxdoo/qooxdoo/blob/%{qxGitBranch}/framework/source/class/%{classFilePath}#L%{lineNumber}"},"svgdemo":{"resourceUri":"../source/resource","sourceUri":"../source/class"}};
