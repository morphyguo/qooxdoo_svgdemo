...
qx.Mixin.define("svg.paint.MStrokeProperties",
{
  ...
  properties :
  {
    ...
    shapeRendering : {
      nullable: true,
      init: null,
      apply: "__applyShapeRendering",
      check: "String",
      event: "changeShapeRendering"
    }
  ...
  members :
  {
    ...
    //applies shape-rendering
    __applyShapeRendering : function(value, old) {
      if (null == value) {
        this.removeAttribute("shape-rendering");
      } else {
        this.setAttribute("shape-rendering", value);
      }
    }
