 ...
 * </ul>
 */
qx.Class.define("svg.struct.FeGaussianBlur", {
  extend: svg.core.Element,

  construct: function() {
    this.base(arguments, "feGaussianBlur");
  },
  ...
  properties: {
    ...
    stdDeviation : {
      nullable: true,
      init: null,
      apply: "__applyStdDeviation",
      check: "String",
      event: "changeStdDeviation"
    }
  },

  members: {
    __applyInFeG: function(value, old) {
      if (null == value) {
    ...
    //applies y
    __applyStdDeviation: function(value, old) {
      if (null == value) {
        this.removeAttribute("stdDeviation");
      } else {
        this.setAttribute("stdDeviation", value);
      }
    }
  }
});